...
def main(args):
    ...
    np.random.seed(seed)
    random.seed(seed)
    model_vit=build_model_vit(args)
    # Data Setup
    dataset_train = build_dataset(image_set='train', args=args,model_vit=model_vit)
    dataset_val = build_dataset(image_set='val' if not args.eval else 'test', args=args,model_vit=model_vit)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--vitposemodel_checkpoint", default="/home/zhengwei/ViPLO/ViTPose/models/vitpose-l.pth", type=str)
    parser.add_argument("--vitposeconfig_path",
                        default="/home/zhengwei/ViPLO/ViTPose/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_large_coco_256x192.py",
                        type=str)
