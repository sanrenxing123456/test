...
if __name__ == '__main__':
    ...
    parser.add_argument("--vitposemodel_checkpoint", default="/zw/ViPLO/ViTPose/models/vitpose-l.pth", type=str)
    parser.add_argument("--vitposeconfig_path",
                        default="/zw/ViPLO/ViTPose/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_large_coco_256x192.py",
                        type=str)
