...
def build(args):
    ...
    config_path = args.vitposeconfig_path
    checkpoint_path = args.vitposemodel_checkpoint
    cfg = Config.fromfile(config_path)
    vitposemodel = build_posenet(cfg.model)
    load_checkpoint(vitposemodel, checkpoint_path, map_location=device)
    ...
    if args.HOIDet and args.STIP_relation_head:
        model = STIP(args, detr=model, detr_matcher=matcher,vit=vitposemodel)
